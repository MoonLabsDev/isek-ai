...
interface Button_GenerateImageProps {
  onClick: () => void;
  disabled?: boolean;
  generating: boolean;
}

const Button_GenerateImage = ({
  onClick,
  disabled,
  generating,
}: Button_GenerateImageProps) => {
  return (
    <button
      onClick={onClick}
    ...
    >
      {generating ? (
        <>
          ...
          <Translation id="components.generateImageButton.generating" />
        </>
      ) : (
        <>
          <svg
          ...
          <Translation id="components.generateImageButton.title" />
        </>
      )}
    </button>
  );
...
export default Button_GenerateImage;
