      ...
      <div className="max-w-4xl w-full">
        ...
        <div className="text-center mt-12">
          <p className="text-gray-400 text-sm mb-4">
            Powered by advanced AI technology • Create, explore, and adventure
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <Link
              href="/world"
              className="inline-flex items-center px-4 py-2 bg-white/10 backdrop-blur-sm rounded-full text-white font-medium hover:bg-white/20 transition-all duration-300"
            >
              <svg
